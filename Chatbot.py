...
def wishme():
    ...
    if 0 <= hour < 12:
        text = "Good Morning sir. I am Friday. How can I Serve you?"
    elif 12 <= hour < 18:
        text = "Good Afternoon sir. I am Friday. How can I Serve you?"
    else:
        text = "Good Evening sir. I am Friday. How can I Serve you?"
...
if __name__ == "__main__":
    ...
    front_image = PhotoImage(file="Bot.png")

    f = Frame(root,width = 8334, height = 8334)
    f.place(x=0,y=0)
    f.tkraise()
    okVar = IntVar()
