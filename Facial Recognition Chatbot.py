...
def load_known_faces(image_paths, names):
    """
    Load known face encodings and their corresponding names from image files.
    ...
    Returns:
    tuple: (known_face_encodings, known_names) where known_face_encodings is a list of face encodings and known_names is a list of names.
    """
    ...
    while True:
        ...
        for face_encoding, face_location in zip(face_encodings, face_locations):
            ...
            if matches[best_match_index]:
                ...
                return  # Exit after starting the chatbot
...
if __name__ == "__main__":
    ...
    image_paths = [r"C:\Users\user\Desktop\bot\person1.jpg"]
    names = ["Suraj"]
